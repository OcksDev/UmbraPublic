...
public class FileSystem : MonoBehaviour
{
    ...
    public Dictionary<string, string> UniversalData = new Dictionary<string, string>();
    ...
    private void Awake()
    {
        ...
        WriteFile($"{UniversalDirectory}\\Player_Data.txt", "", false);
        GameName = $"Umbra {RandomFunctions.Instance.GameVer}";
